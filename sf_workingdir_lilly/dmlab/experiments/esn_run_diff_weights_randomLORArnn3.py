...
cli = (
    ...
    "--wandb_project=SF_dmlab_rnn_random_lora_40 "  # TODO change the project name for different trials
    "--benchmark=False "
...
_experiments = [
    Experiment("RNNRandomLORA40", cli, _params.generate_params(False)),  # TODO
]
