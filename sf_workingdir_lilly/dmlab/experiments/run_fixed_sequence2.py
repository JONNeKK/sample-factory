...
cli = (
    ...
    "--wandb_project=SF_dmlab_rnn_fixed_sequence_44 "  # TODO change the project name for different trials
    "--benchmark=False "
...
_experiments = [
    Experiment("RNNFixedSequence44", cli, _params.generate_params(False)),  # TODO
]
