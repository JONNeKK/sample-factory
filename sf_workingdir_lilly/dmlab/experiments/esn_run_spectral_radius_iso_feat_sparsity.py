...
cli = (
    ...
    "--wandb_project=SF_dmlab_esn_sparsity_10 "  # TODO change the project name for different trials
    "--benchmark=False "
...
_experiments = [
    Experiment("ESNSparsityIsolatedFeaturesFixedWhhWih", cli, _params.generate_params(False)),  # TODO
]
