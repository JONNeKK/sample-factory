...
cli = (
    ...
    "--wandb_project=SF_dmlab_lilly_esn_spectral_radius_iso_feat_TEST6 "  # TODO change the project name for different trials
    "--benchmark=False "
...
_experiments = [
    Experiment("ESNSpectralRadiusWithIsolatedFeatures", cli, _params.generate_params(False)),  # TODO
]
