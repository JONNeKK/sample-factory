...
cli = (
    ...
    "--wandb_project=SF_dmlab_esn_different_weights_38 "  # TODO change the project name for different trials
    "--benchmark=False "
...
_experiments = [
    Experiment("ESNDifferentWeightsIsolatedFeatures38", cli, _params.generate_params(False)),  # TODO
]
