...
_params = ParamGrid(
    [
        ...
        ("weight_trial",[33, 12, 49, 15, 3, 23, 43, 39])
    ]
)
...
cli = (
    ...
    "--wandb_project=SF_dmlab_esn_different_weights_21 "  # TODO change the project name for different trials
    "--benchmark=False "
...
_experiments = [
    Experiment("ESNDifferentWeightsIsolatedFeatures21", cli, _params.generate_params(False)),  # TODO
]
