...
cli = (
    ...
    "--wandb_project=SF_dmlab_rnn_random_lora_48 "  # TODO change the project name for different trials
    "--benchmark=False "
...
_experiments = [
    Experiment("RNNRandomLORA48", cli, _params.generate_params(False)),  # TODO
]
