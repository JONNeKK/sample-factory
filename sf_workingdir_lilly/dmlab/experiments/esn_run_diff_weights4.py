...
_params = ParamGrid(
    [
        ...
        ("weight_trial",[35, 8, 37, 36, 15, 21, 27, 13]) 
    ]
)
...
cli = (
    ...
    "--Hippo_R=8 "
    "--rnn_size=1149 "
    "--spectral_radius=1.2 "  # TODO
    "--sparsity=0.2 "
    "--weight_trial=6 " # TODO
    "--weight_folder=weights1.2 " # TODO
    ...
    "--wandb_project=SF_dmlab_esn_different_weights_20 "  # TODO change the project name for different trials
    "--benchmark=False "
...
_experiments = [
    Experiment("ESNDifferentWeightsIsolatedFeatures20", cli, _params.generate_params(False)),  # TODO
]
