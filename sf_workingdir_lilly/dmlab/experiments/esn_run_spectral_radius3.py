...
cli = (
    ...
    "--wandb_project=SF_dmlab_lilly_esn_spectral_radius_TEST5 "  # TODO change the project name for different trials
    "--benchmark=False "
...
_experiments = [
    Experiment("ESNSpectralRadius5", cli, _params.generate_params(False)),  # TODO
]
