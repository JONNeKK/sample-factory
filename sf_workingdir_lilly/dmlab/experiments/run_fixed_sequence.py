...
cli = (
    ...
    "--wandb_project=SF_dmlab_rnn_fixed_sequence_33 "  # TODO change the project name for different trials
    "--benchmark=False "
...
_experiments = [
    Experiment("RNNFixedSequence33", cli, _params.generate_params(False)),  # TODO
]
