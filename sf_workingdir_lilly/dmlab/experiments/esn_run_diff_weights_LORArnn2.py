...
cli = (
    ...
    "--core_name=BypassFixedESNPreGeneratedWeightsLORA "
    ...
    "--wandb_project=SF_dmlab_rnn_lora_45 "  # TODO change the project name for different trials
    "--benchmark=False "
...
_experiments = [
    Experiment("RNNLORA45", cli, _params.generate_params(False)),  # TODO
]
