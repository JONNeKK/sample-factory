...
cli = (
    ...
    "--wandb_project=SF_dmlab_esn_extensive_spectral_radius_10 "  # TODO change the project name for different trials
    "--benchmark=False "
...
_experiments = [
    Experiment("ESExtensiveNSpectralRadiusWithIsolatedFeaturesFixedWhh10", cli, _params.generate_params(False)),  # TODO
]
