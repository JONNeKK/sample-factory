...
cli = (
    ...
    "--wandb_project=SF_dmlab_esn_different_weights_42 "  # TODO change the project name for different trials
    "--benchmark=False "
...
_experiments = [
    Experiment("ESNDifferentWeightsIsolatedFeatures42", cli, _params.generate_params(False)),  # TODO
]
