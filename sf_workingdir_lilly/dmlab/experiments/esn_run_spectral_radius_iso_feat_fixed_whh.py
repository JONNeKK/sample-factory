...
cli = (
    ...
    "--wandb_project=SF_dmlab_esn_extensive_spectral_radius_9.1 "  # TODO change the project name for different trials
    "--benchmark=False "
...
_experiments = [
    Experiment("ESExtensiveNSpectralRadiusWithIsolatedFeaturesFixedWhh9", cli, _params.generate_params(False)),  # TODO
]
