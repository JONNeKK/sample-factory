...
cli = (
    ...
    "--wandb_project=SF_dmlab_rnn_fixed_sequence_lora_49 "  # TODO change the project name for different trials
    "--benchmark=False "
...
_experiments = [
    Experiment("RNNFixedSequenceLORA49", cli, _params.generate_params(False)),  # TODO
]
