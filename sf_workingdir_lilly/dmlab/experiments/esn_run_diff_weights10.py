...
_params = ParamGrid(
    [
        ...
        ("weight_trial", [14, 39, 23, 45, 8, 22, 17, 15, 38, 4, 11, 1, 9, 3, 18, 33, 6, 12, 49, 43,7, 41, 35, 5, 40, 42, 27, 36, 13, 24, 28, 30, 47, 29]) 
...
cli = (
    ...
    "--wandb_project=SF_dmlab_esn_different_weights_44 "  # TODO change the project name for different trials
    "--benchmark=False "
...
_experiments = [
    Experiment("ESNDifferentWeightsIsolatedFeatures44", cli, _params.generate_params(False)),  # TODO
]
