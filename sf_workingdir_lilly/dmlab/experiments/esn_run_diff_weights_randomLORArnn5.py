...
_params = ParamGrid(
    [
        ...
        ("weight_trial",[14, 39, 23, 45,  8, 22, 17, 15, 38,  4, 11,  1,  9,  3, 18, 33,  6, 12, 49, 43,  7, 41, 35,  5, 40, 42, 27, 36, 13, 24, 28, 30, 47, 29])  # 14, 39, 23, 45, 24, 30, 29
    ]
)
...
cli = (
    ...
    "--core_name=BypassFixedESNRandomNetworkLORA "
    ...
    "--wandb_project=SF_dmlab_rnn_random_lora_47 "  # TODO change the project name for different trials
    "--benchmark=False "
...
_experiments = [
    Experiment("RNNRandomLORA47", cli, _params.generate_params(False)),  # TODO
]
